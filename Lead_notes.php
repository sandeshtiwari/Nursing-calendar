    ...
    if(!empty($myClasses)){
          ...
          foreach($notes as $note => $details){
           ...
           echo"<tr>
                 ...
                 <button class='btn btn-warning btn-delt' type='button' data-toggle='collapse' data-target='#$Note' aria-expanded='false' aria-controls='$Note'>Edit </button>                 
                  <a onclick='return confirm('are you sure?') href='noteHelp.php?id=delete&week=$Week&course=$Course_ID' class = 'btn btn-danger btn-rounded btn-edit'>Delete</a><td>
                        ";
                  }           
               echo " </tr>";
